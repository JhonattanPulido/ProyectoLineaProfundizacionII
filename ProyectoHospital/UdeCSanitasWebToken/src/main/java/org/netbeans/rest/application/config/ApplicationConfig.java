...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(com.udecsanitas.udecsanitasweb.controller.SeguridadController.class);
        resources.add(com.udecsanitas.udecsanitasweb.controller.authorized.AuthrorizedFilter.class);
        resources.add(com.udecsanitas.udecsanitasweb.controller.exception.filter.BadRequestExceptionFilter.class);
        ...
        resources.add(com.udecsanitas.udecsanitasweb.controller.exception.filter.UnauthorizedExceptionFilter.class);
